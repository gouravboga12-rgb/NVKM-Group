const PRODUCTS_DATA = [
  // 1. Tomato Powder
  {
    ...
    short_desc: "Experience the pure, fresh goodness of NVKM Dry-Fresh Tomato Powder â€” crafted for health-conscious consumers and professional culinary applications.",
    long_desc: "Experience the pure, fresh goodness of NVKM Dry-Fresh Tomato Powder, crafted for health-conscious consumers and professional culinary applications. Our premium powder is derived from high-quality, farm-fresh Tomato, utilizing advanced dehydration technology to lock in essential nutrients, fresh sweetness, and authentic flavor.",
    benefits: [
      "Pure Farm-Fresh Tomatoes",
    ...
    reviews: [
      ...
      { name: "Rajesh K.", rating: 5, date: "2026-05-20", comment: "Absolutely pure and high quality. Highly recommended!" }
    ]
  },
  ...
  // 2. Raw Banana Powder
  {
    ...
    category: "Fruits and Vegetable Powder",
    short_desc: "Experience the pure, fresh goodness of NVKM Dry-Fresh Banana Powder â€” crafted for health-conscious consumers and professional culinary applications.",
    long_desc: "Experience the pure, fresh goodness of NVKM Dry-Fresh Banana Powder, crafted for health-conscious consumers and professional culinary applications. Our premium powder is derived from high-quality, farm-fresh Raw Banana, utilizing advanced dehydration technology to lock in essential nutrients, fresh sweetness, and authentic flavor.",
    benefits: [
      "Pure Farm-Fresh Raw Banana",
      "Rich in Resistant Starch, Potassium, and Dietary Fiber",
      "Supports digestion, gut health, and daily energy",
      "Gluten-free, vegan-friendly, zero artificial preservatives"
    ],
    ingredients: "Pure Dehydrated Farm-Fresh Raw Banana",
    usage_info: "Add 1-2 tablespoons to baby food, porridge, smoothies, or baking recipes. Ideal for health-conscious recipes and energy boosting.",
    ...
    reviews: [
      { name: "Priya M.", rating: 5, date: "2026-05-02", comment: "Very fresh sweetness, no artificial smell. Highly recommend for infants as a healthy porridge mix." },
  ...
  // 3. Carrot Powder
  {
    ...
    category: "Fruits and Vegetable Powder",
    short_desc: "Experience the pure, fresh goodness of NVKM Dry-Fresh Carrot Powder â€” crafted for health-conscious consumers and professional culinary applications.",
    long_desc: "Experience the pure, fresh goodness of NVKM Dry-Fresh Carrot Powder, crafted for health-conscious consumers and professional culinary applications. Our premium powder is derived from high-quality, farm-fresh Carrot, utilizing advanced dehydration technology to lock in essential nutrients, fresh sweetness, and authentic flavor.",
    benefits: [
      "Pure Farm-Fresh Carrots",
      "Rich in Beta-Carotene, Vitamin A, and Antioxidants",
      "Supports eye health, immunity, and healthy skin glow",
      "No artificial colors, preservatives, or fillers"
    ],
    ingredients: "Pure Dehydrated Farm-Fresh Carrots",
    usage_info: "Blend 1-2 teaspoons into soups, juices, smoothies, baby food, or baked goods. Adds rich color and nutrition to your daily meals.",
  ...
  // 4. Beetroot Powder
  {
    ...
    category: "Fruits and Vegetable Powder",
    short_desc: "Experience the pure, fresh goodness of NVKM Dry-Fresh Beetroot Powder â€” crafted for health-conscious consumers and professional culinary applications.",
    long_desc: "Experience the pure, fresh goodness of NVKM Dry-Fresh Beetroot Powder, crafted for health-conscious consumers and professional culinary applications. Our premium powder is derived from high-quality, farm-fresh Beetroot, utilizing advanced dehydration technology to lock in essential nutrients, fresh sweetness, and authentic flavor.",
    benefits: [
      "Pure Farm-Fresh Beetroot",
      "Rich in Nitrates, Iron, Folate, and Antioxidants",
      "Supports healthy blood pressure, stamina, and detox",
      "Vibrant rich color â€” no artificial dyes added"
    ],
    ingredients: "Pure Dehydrated Farm-Fresh Beetroot",
    usage_info: "Mix 1 teaspoon in water, smoothies, or juices. Use as a food color for rotis and cakes. Excellent pre-workout daily energy drink.",
  ...
  // 5. Moringa Powder
  {
    ...
    category: "Fruits and Vegetable Powder",
    short_desc: "Experience the pure, fresh goodness of NVKM Dry-Fresh Moringa Leaves Powder â€” crafted for health-conscious consumers and professional culinary applications.",
    long_desc: "Experience the pure, fresh goodness of NVKM Dry-Fresh Moringa Leaves Powder, crafted for health-conscious consumers and professional culinary applications. Our premium powder is derived from high-quality, farm-fresh Moringa Leaves, utilizing advanced dehydration technology to lock in essential nutrients, fresh sweetness, and authentic flavor.",
    benefits: [
      ...
      "Detoxifying and revitalizing properties"
    ],
    ingredients: "Pure Dried Moringa Leaves (Moringa Oleifera)",
    ...
    reviews: [
      ...
      { name: "Anjali J.", rating: 5, date: "2026-05-10", comment: "Top quality packaging, and the leaf powder smells genuine and grassy. Great healthy supplement." }
    ]
  },
  ...
  // 6. Hand Made Full White Round Wicks
  {
    ...
    benefits: [
      "Pure White Cotton, hand-rolled for consistent quality",
  ...
  // 7. Long Cotton
  {
    ...
    benefits: [
      "Pure White Cotton for clean, smokeless burn",
  ...
  // 8. 4 inch Long Cotton Wicks
  {
    ...
    benefits: [
      "Pure White First Quality Cotton",

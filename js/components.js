      ...
      <div class="p-5 flex-1 flex flex-col justify-between">
        ...
        <div>
          ...
          <div class="mt-4 grid grid-cols-2 gap-2">
            <button onclick="addToCart('${product.id}', '${defaultVar.weight}')" class="bg-slate-100 hover:bg-primary hover:text-white text-primary font-bold text-xs py-2.5 px-3 rounded-xl transition-all flex items-center justify-center gap-1.5 border border-transparent hover:shadow-md">
              <i class="fa-solid fa-cart-shopping"></i> Add to Cart
            </button>
            <button onclick="addToCart('${product.id}', '${defaultVar.weight}', 1, true); toggleCartDrawer(true);" class="bg-accent hover:bg-accentHover text-white font-bold text-xs py-2.5 px-3 rounded-xl transition-all flex items-center justify-center gap-1.5 shadow-sm hover:shadow-md shadow-accent/10">
              <i class="fa-solid fa-bolt"></i> Buy Now
            </button>
          </div>
          
          <!-- WhatsApp Enquiry Button -->
          <button onclick="window.open('https://wa.me/9014274293?text=Hello%20NVKM%20GROUP,%20I%20am%20interested%20in%2520purchasing%2520your%2520natural%2520powder:%20${encodeURIComponent(product.name)}%2520(${defaultVar.weight}%2520size).%20Please%20provide%20rates.', '_blank')" class="w-full mt-2 bg-emerald-50 hover:bg-emerald-600 hover:text-white text-emerald-800 border border-emerald-200 hover:border-emerald-600 font-bold text-xs py-2 rounded-xl transition-all flex items-center justify-center gap-1.5">
...
function renderHomeView() {
  ...
  const categories = [
    ...
    { name: "Moringa Powder", icon: "fa-solid fa-leaf", color: "from-emerald-100 to-green-100", text: "Organic leaves superfood filled with minerals & antioxidants." },
    ...
    { name: "Vegetable Powders", icon: "fa-solid fa-carrot", color: "from-green-100 to-lime-100", text: "Nutrient-packed dehydrated vegetables for healthy cooking." },
    { name: "Health Powders", icon: "fa-solid fa-mortar-pestle", color: "from-teal-100 to-cyan-100", text: "Immunity adaptogens designed for vitality and active life." },
    { name: "Natural Powders", icon: "fa-solid fa-spa", color: "from-emerald-50 to-emerald-100", text: "Preservative-free botanical powders for wellness & body care." }
  ];
  ...
  return `
    ...
    <section class="relative overflow-hidden py-16 lg:py-28 bg-gradient-to-br from-[#14532D] via-[#103d21] to-emerald-950 rounded-[40px] text-white shadow-2xl mt-4">
      <div class="absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,rgba(74,222,128,0.15),transparent)] pointer-events-none"></div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10 px-6 sm:px-12 lg:px-16">
        ...
        <div class="lg:col-span-7 space-y-6 text-left" data-aos="fade-right">
          <span class="inline-flex items-center gap-2 bg-emerald-800/60 border border-emerald-700/50 px-3 py-1 rounded-full text-xs font-semibold tracking-wider text-secondary shadow-sm">
          ...
          <div class="flex flex-wrap gap-3 pt-2">
            ...
            <a href="https://wa.me/9014274293?text=${encodeURIComponent(GENERAL_WA_MSG)}" target="_blank" class="bg-white/10 hover:bg-white/20 border border-white/20 text-white font-bold px-7 py-3.5 rounded-2xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-2 text-sm">
              <i class="fa-brands fa-whatsapp text-lg text-emerald-400"></i> Contact on WhatsApp
            </a>
          </div>
        </div>
    ...
    <section class="py-12 mt-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow" data-aos="fade-up" data-aos-delay="100">
          <div class="w-12 h-12 rounded-2xl bg-emerald-50 text-primary flex items-center justify-center text-xl mb-6"><i class="fa-solid fa-certificate"></i></div>
        ...
        <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow" data-aos="fade-up" data-aos-delay="200">
          <div class="w-12 h-12 rounded-2xl bg-emerald-50 text-primary flex items-center justify-center text-xl mb-6"><i class="fa-solid fa-dna"></i></div>
        ...
        <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow" data-aos="fade-up" data-aos-delay="300">
          <div class="w-12 h-12 rounded-2xl bg-emerald-50 text-primary flex items-center justify-center text-xl mb-6"><i class="fa-solid fa-box-tissue"></i></div>
    ...
    <section class="py-12" data-aos="fade-up">
      <div class="bg-gradient-to-tr from-primary to-emerald-900 text-white rounded-[35px] p-8 md:p-12 shadow-xl flex flex-col md:flex-row items-center gap-8 relative overflow-hidden">
        <div class="absolute right-0 bottom-0 top-0 w-1/3 bg-[radial-gradient(circle_at_right_bottom,rgba(74,222,128,0.15),transparent)] pointer-events-none"></div>
        <div class="flex-1 space-y-4">
          <span class="bg-emerald-800 text-secondary border border-emerald-700/50 text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">Wholesale & Retail Supplier</span>
    ...
    <section class="py-12">
      ...
      <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
        <div class="bg-white p-6 rounded-3xl border border-slate-100 text-center flex flex-col items-center shadow-sm" data-aos="fade-up" data-aos-delay="100">
          <div class="w-10 h-10 rounded-xl bg-emerald-50 text-primary flex items-center justify-center text-lg mb-4"><i class="fa-solid fa-seedling"></i></div>
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-100 text-center flex flex-col items-center shadow-sm" data-aos="fade-up" data-aos-delay="200">
          <div class="w-10 h-10 rounded-xl bg-emerald-50 text-primary flex items-center justify-center text-lg mb-4"><i class="fa-solid fa-award"></i></div>
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-100 text-center flex flex-col items-center shadow-sm" data-aos="fade-up" data-aos-delay="300">
          <div class="w-10 h-10 rounded-xl bg-emerald-50 text-primary flex items-center justify-center text-lg mb-4"><i class="fa-solid fa-tags"></i></div>
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-100 text-center flex flex-col items-center shadow-sm" data-aos="fade-up" data-aos-delay="400">
          <div class="w-10 h-10 rounded-xl bg-emerald-50 text-primary flex items-center justify-center text-lg mb-4"><i class="fa-solid fa-truck"></i></div>
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-100 text-center flex flex-col items-center shadow-sm" data-aos="fade-up" data-aos-delay="500">
          <div class="w-10 h-10 rounded-xl bg-emerald-50 text-primary flex items-center justify-center text-lg mb-4"><i class="fa-solid fa-handshake-angle"></i></div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm relative" data-aos="fade-up">
          ...
          <div class="mt-4 border-t pt-3 border-slate-50 flex items-center gap-3">
            <div class="w-9 h-9 rounded-full bg-emerald-100 flex items-center justify-center font-bold text-primary text-xs">P</div>
            <div>
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm relative" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="mt-4 border-t pt-3 border-slate-50 flex items-center gap-3">
            <div class="w-9 h-9 rounded-full bg-emerald-100 flex items-center justify-center font-bold text-primary text-xs">R</div>
            <div>
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm relative" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="mt-4 border-t pt-3 border-slate-50 flex items-center gap-3">
            <div class="w-9 h-9 rounded-full bg-emerald-100 flex items-center justify-center font-bold text-primary text-xs">K</div>
            <div>
...
function renderShopView() {
  const categoryFilters = ["All", "Banana Powder", "Moringa Powder", "Fruit Powders", "Vegetable Powders", "Health Powders", "Natural Powders"];
  let filtersHtml = "";
  categoryFilters.forEach(cat => {
    filtersHtml += `
      <button onclick="handleCategoryFilter('${cat}')" class="px-4 py-2 text-xs font-bold rounded-xl transition-all ${state.selectedCategory === cat ? 'bg-primary text-white shadow-md' : 'bg-white hover:bg-slate-100 text-slate-600 border'}" id="filter-btn-${cat.replace(/\s+/g, '-')}">
        ${cat}
      </button>
    `;
  });
  ...
  return `
    <div class="py-6">
      ...
      <div id="shop-empty-state" class="hidden flex-col items-center justify-center py-20 text-center">
        ...
        <button onclick="handleCategoryFilter('All'); handleSearch('');" class="mt-6 bg-primary hover:bg-emerald-800 text-white font-bold py-2.5 px-6 rounded-xl text-xs transition-all shadow-sm">
          Reset Filters
        </button>
      </div>
  ...
  product.variations.forEach((v, index) => {
    weightsHtml += `
      <label class="flex-1 cursor-pointer">
        ...
        <div class="border border-slate-200 peer-checked:border-primary peer-checked:bg-emerald-50 rounded-2xl py-3 px-4 text-center transition-all shadow-sm hover:border-slate-300">
      ...
      <div class="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 bg-white border border-slate-100 rounded-[35px] p-6 md:p-10 shadow-sm" data-aos="fade-up">
        ...
        <div class="md:col-span-5 space-y-4">
          ...
          <div class="grid grid-cols-3 gap-3">
            <div class="border-2 border-primary bg-emerald-50 rounded-2xl overflow-hidden aspect-square cursor-pointer">
        ...
        <div class="md:col-span-7 flex flex-col justify-between space-y-6">
          ...
          <div class="flex flex-col sm:flex-row gap-3 pt-4 border-t border-slate-100">
            ...
            <button onclick="submitPdWhatsAppInquiry('${product.id}')" class="bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 px-5 rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-600/25 transition-all hover:scale-[1.01]" title="Inquire on WhatsApp">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8" data-aos="fade-up">
        ...
        <div class="bg-white border border-slate-100 rounded-[35px] p-6 md:p-8 shadow-sm">
          ...
          <form onsubmit="handleReviewSubmit(event, '${product.id}')" class="space-y-4 mt-4">
            ...
            <button type="submit" class="w-full bg-primary hover:bg-emerald-850 text-white font-bold py-3 rounded-xl text-xs transition-colors shadow-sm">
              Submit My Review
            </button>
          </form>
        </div>
  ...
  return `
    <div class="py-6 space-y-12">
      ...
      <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-center bg-white border border-slate-100 rounded-[35px] p-6 md:p-10 shadow-sm" data-aos="fade-up">
        <div class="md:col-span-5 aspect-[4/5] bg-emerald-50 rounded-3xl overflow-hidden shadow-inner flex items-center justify-center relative">
        ...
        <div class="md:col-span-7 space-y-6">
          <span class="inline-block bg-emerald-50 border border-emerald-200 text-primary text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">Manufacturing Business</span>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="bg-gradient-to-tr from-primary to-emerald-900 text-white p-8 md:p-10 rounded-[35px] shadow-sm relative overflow-hidden" data-aos="fade-up">
          <div class="absolute right-0 bottom-0 top-0 w-1/3 bg-[radial-gradient(circle_at_right_bottom,rgba(74,222,128,0.1),transparent)] pointer-events-none"></div>
        ...
        <div class="bg-white border border-slate-100 text-darkText p-8 md:p-10 rounded-[35px] shadow-sm relative overflow-hidden" data-aos="fade-up" data-aos-delay="100">
          <div class="w-10 h-10 rounded-xl bg-emerald-50 flex items-center justify-center text-primary mb-6"><i class="fa-solid fa-bullseye text-lg"></i></div>
      ...
      <div class="py-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          <div class="bg-white border border-slate-100 p-6 rounded-3xl text-center shadow-sm" data-aos="fade-up" data-aos-delay="100">
            <div class="w-10 h-10 rounded-xl bg-emerald-50 text-primary flex items-center justify-center text-base mb-4 mx-auto"><i class="fa-solid fa-award"></i></div>
          ...
          <div class="bg-white border border-slate-100 p-6 rounded-3xl text-center shadow-sm" data-aos="fade-up" data-aos-delay="200">
            <div class="w-10 h-10 rounded-xl bg-emerald-50 text-primary flex items-center justify-center text-base mb-4 mx-auto"><i class="fa-solid fa-seedling"></i></div>
          ...
          <div class="bg-white border border-slate-100 p-6 rounded-3xl text-center shadow-sm" data-aos="fade-up" data-aos-delay="300">
            <div class="w-10 h-10 rounded-xl bg-emerald-50 text-primary flex items-center justify-center text-base mb-4 mx-auto"><i class="fa-solid fa-heart-pulse"></i></div>
          ...
          <div class="bg-white border border-slate-100 p-6 rounded-3xl text-center shadow-sm" data-aos="fade-up" data-aos-delay="400">
            <div class="w-10 h-10 rounded-xl bg-emerald-50 text-primary flex items-center justify-center text-base mb-4 mx-auto"><i class="fa-solid fa-shield-check"></i></div>
          ...
          <div class="bg-white border border-slate-100 p-6 rounded-3xl text-center shadow-sm" data-aos="fade-up" data-aos-delay="500">
            <div class="w-10 h-10 rounded-xl bg-emerald-50 text-primary flex items-center justify-center text-base mb-4 mx-auto"><i class="fa-solid fa-face-smile-wink"></i></div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div class="lg:col-span-7 bg-white border border-slate-100 rounded-[35px] p-6 md:p-8 shadow-sm" data-aos="fade-right">
          ...
          <form id="contact-form" class="space-y-4">
            ...
            <button type="submit" class="w-full sm:w-auto bg-primary hover:bg-emerald-850 text-white font-bold py-3 px-8 rounded-xl text-xs transition-colors shadow-md">
              Send Message
            </button>
          </form>
        </div>
        ...
        <div class="lg:col-span-5 space-y-6" data-aos="fade-left">
          ...
          <div class="bg-white border border-slate-100 rounded-[35px] p-6 md:p-8 shadow-sm space-y-6">
            ...
            <div class="space-y-4 text-sm">
              <div class="flex items-start gap-4">
                <div class="w-9 h-9 rounded-full bg-emerald-50 text-primary flex items-center justify-center shrink-0"><i class="fa-solid fa-phone text-sm"></i></div>
                <div>
              ...
              <div class="flex items-start gap-4 border-t border-slate-100 pt-4">
                <div class="w-9 h-9 rounded-full bg-emerald-50 text-primary flex items-center justify-center shrink-0"><i class="fa-brands fa-whatsapp text-lg"></i></div>
                <div>
                  <span class="text-xs text-slate-400 font-semibold block uppercase">WhatsApp Chats</span>
                  <a href="https://wa.me/9014274293?text=${encodeURIComponent(GENERAL_WA_MSG)}" target="_blank" class="font-bold text-emerald-600 hover:text-accent transition-colors block mt-0.5">+91 9014274293</a>
                  <a href="https://wa.me/7075604700?text=${encodeURIComponent(GENERAL_WA_MSG)}" target="_blank" class="font-bold text-emerald-600 hover:text-accent transition-colors block">+91 7075604700</a>
                </div>
              </div>

              <div class="flex items-start gap-4 border-t border-slate-100 pt-4">
                <div class="w-9 h-9 rounded-full bg-emerald-50 text-primary flex items-center justify-center shrink-0"><i class="fa-regular fa-envelope"></i></div>
                <div>
              ...
              <div class="flex items-start gap-4 border-t border-slate-100 pt-4">
                <div class="w-9 h-9 rounded-full bg-emerald-50 text-primary flex items-center justify-center shrink-0"><i class="fa-solid fa-map-location-dot"></i></div>
                <div>
          ...
          <!-- Business Hours -->
          <div class="bg-gradient-to-tr from-primary to-emerald-900 text-white rounded-[30px] p-6 shadow-sm">
      ...
      <div class="bg-white border border-slate-100 rounded-[35px] p-6 md:p-8 shadow-xl w-full max-w-md" data-aos="zoom-in">
        ...
        <div id="auth-form-login" class="space-y-4">
          ...
          <form id="login-form-el" class="space-y-4">
            ...
            <button type="submit" class="w-full bg-primary hover:bg-emerald-850 text-white font-bold py-3 rounded-xl text-xs transition-colors shadow-md">
              Sign In
            </button>
          </form>
  ...
  if (state.orderHistory && state.orderHistory.length > 0) {
    ...
    ordersListHtml = `
      <div class="text-center py-10 border border-dashed rounded-2xl bg-slate-50/50">
        ...
        <button onclick="navigate('shop')" class="mt-4 bg-primary hover:bg-emerald-850 text-white font-bold py-2 px-5 rounded-xl text-xs shadow-sm">
          Shop Powders
        </button>
      </div>
    `;
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div class="lg:col-span-4 bg-white border border-slate-100 rounded-[35px] p-6 md:p-8 shadow-sm space-y-6" data-aos="fade-right">
          <div class="text-center space-y-2">
            <div class="w-16 h-16 rounded-full bg-emerald-50 text-primary flex items-center justify-center font-heading font-bold text-2xl mx-auto shadow-inner border border-primary/10">
              ${user.name.charAt(0)}
            </div>
            <h3 class="font-heading font-bold text-lg text-darkText">${user.name}</h3>
            <span class="inline-block bg-emerald-50 border border-emerald-200 text-primary text-[10px] font-bold px-3 py-0.5 rounded-full uppercase tracking-wider">Premium Customer</span>
          </div>
...
function renderFooter() {
  return `
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div class="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
        ...
        <div class="md:col-span-5 space-y-5">
          ...
          <div class="flex items-center space-x-3 text-sm">
            <a href="https://wa.me/9014274293" target="_blank" class="w-8 h-8 rounded-full bg-emerald-950 border border-emerald-800 text-slate-300 hover:text-white hover:bg-emerald-800 flex items-center justify-center transition-colors"><i class="fa-brands fa-whatsapp"></i></a>
            <a href="tel:9014274293" class="w-8 h-8 rounded-full bg-emerald-950 border border-emerald-800 text-slate-300 hover:text-white hover:bg-emerald-800 flex items-center justify-center transition-colors"><i class="fa-solid fa-phone"></i></a>
            <a href="mailto:Navakiranamgroup@gmail.com" class="w-8 h-8 rounded-full bg-emerald-950 border border-emerald-800 text-slate-300 hover:text-white hover:bg-emerald-800 flex items-center justify-center transition-colors"><i class="fa-regular fa-envelope"></i></a>
          </div>
        </div>
      ...
      <!-- Copyright bottom -->
      <div class="border-t border-emerald-950 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-[10px] text-slate-500 font-light">
